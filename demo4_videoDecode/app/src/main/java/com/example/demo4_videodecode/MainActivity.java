package com.example.demo4_videodecode;
...
public class MainActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(MainActivity.this, "解码完成，请自行从手机中拉取yuv文件", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    public native void decode_test(String inputStr,int flag,String outputStr);
}